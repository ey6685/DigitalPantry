...
$('#editEmailButton').click(function showEditField (e) {
  ...
  $("<div id='newUsername' class='form-row'><div class='form-group col-md-3'><input name='newUsername' class='form-control' placeholder='New username' required='' ></div></div>").insertAfter($('#userEmail'))
  // show save button
  $("<button class='btn btn-primary' type='submit' id='saveEmailButton'>Save</button>").insertAfter($('#newUsername'))
  // show cancel button
  $("<button class='btn btn-danger' type='button' id='cancelPassEdit'>Cancel</button>").insertAfter($('#saveEmailButton'))
})
